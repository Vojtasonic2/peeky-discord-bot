...
bot.on('message', (message) => { //Fight
    if(message.content.startsWith("/Fight ")){
        ...
        message.channel.sendMessage('**' + message.author.tag + '** has won!')
        if(health_2 < health_1){
        message.channel.sendMessage('**' + message.mentions.members.first().displayName + '** has won!')
        if(health_2 == health_1){
        message.channel.sendMessage('**No one** has won!')
